"""
author: Tiffany Lee
file: /Users/tiffanylee/Downloads/Personal Projects/Advent_of_Code/2022/InputFiles_2022/Day04_Input.txt
...
by 4-6. In pairs where one assignment fully contains the other, one Elf
in the pair would be exclusively cleaning sections their partner will
...
def part1(filename):
    ...
    for line in open(filename):
        ...
        if (x1 <= y1 and x2 >= y2) or (y1 <= x1 and y2 >= x2):
            pairContains += 1
    print("Part One: In how many assignment pairs does one range "
          + "fully contain the other?"
          + "\nANSWER: " + str(pairContains) + " pairs")
...
def part2(filename):
    ...
    print("\nPart Two: In how many assignment pairs do the ranges overlap?"
          + "\nANSWER: " + str(pairOverlaps) + " pairs")


def main():
    filepath = "/Users/tiffanylee/Downloads/Personal Projects/Advent_of_Code/2022/InputFiles_2022/Day04_Input.txt"
    part1(filepath)
    part2(filepath)
main()