"""
author: Tiffany Lee
file: /Users/tiffanylee/Downloads/Personal Projects/Advent_of_Code/2022/InputFiles_2022/Day10_Input.txt

--- Day 10: Cathode-Ray Tube ---
You avoid the ropes, plunge into the river, and swim to shore. The Elves yell
something about meeting back up with them upriver, but the river is too loud to
tell exactly what they're saying. They finish crossing the bridge and disappear
from view. Situations like this must be why the Elves prioritized getting the
...
tell the screen what to draw. Consider the following small program:
...
(the cycle number multiplied by the value of the X register) during the
20th cycle and every 40 cycles after that (that is, during the 20th, 60th,
...
as "vertical position": if the sprite's horizontal position puts its pixels
...
"""
def main():
    filepath = "/Users/tiffanylee/Downloads/Personal Projects/Advent_of_Code/2022/InputFiles_2022/Day10_Input.txt"
    ...
    for line in info:
        ...
        if line.startswith("noop"):
            ...
            cycles.append(x)
            x += val
    strengthSum = sum(x*y + y for x,y in list(enumerate(cycles))[19::40])
    print("Part One: Find the signal strength during the 20th, 60th, 100th, 140th,"
          + "180th, and 220th cycles. What is the sum of these six signal strengths?"
          + "\nANSWER " + str(strengthSum))

    print("\nPart Two: Render the image given by your program. "
          + "What eight capital letters appear on your CRT?"
          + "\nANSWER: ")
